    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Job Career Enquiry </div>
                <div class="ps-3">
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <form class="row g-3 form_class" action="{{ route('admin.email.send') }}" method="post">
                                    ...
                                    <input type="hidden" name="type" value="job_career">
                                    <div class="col-md-12">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#example').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('admin.enquiry.job-career.list') }}',
                },
                columns: [{
                        data: 'name',
                        name: 'name'
                ...
                columnDefs: [{
                    ...
                    "render": function(data, type, full) {
                        return `<textarea class="form-control" style="width:fit-content;height:150px" readonly>${full.message}</textarea>`;
                    }
                }, {
                    "targets": 5,
                    "render": function(data, type, full) {
                        return (full.cv) ? `<a href="/${full.cv}" target="_blank">Resume</a>` :
                            '';
                    }
                }, {
                    "targets": 7,
        ...
        function sendEmail(row) {
            var resume = `{{ url('/${row.cv}') }}`;
            var text = `Name: ${row.name}
            Email: ${row.email}
            Phone: ${row.phone}
            Message: ${row.message}
            Company: ${row.company}
            CV/Resume: ${resume}`.replace(/^\s+/gm, '');

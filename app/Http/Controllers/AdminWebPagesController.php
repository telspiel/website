<?php namespace App\Http\Controllers;
	...
	class AdminWebPagesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Meta Desc","name"=>"meta_desc"];
			$this->col[] = ["label"=>"Meta Keyword","name"=>"meta_keyword"];
			...
			//$this->form[] = ["label"=>"Meta Desc","name"=>"meta_desc","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];

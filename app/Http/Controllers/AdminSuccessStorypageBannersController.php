<?php namespace App\Http\Controllers;
	...
	class AdminSuccessStorypageBannersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "success_storypage_banners";
			...
			$this->form[] = ['label'=>'Cta Name','name'=>'cta_name','type'=>'text','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Cta Link','name'=>'cta_link','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ["label"=>"Image Title","name"=>"image_title","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Cta Name","name"=>"cta_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"Cta Link","name"=>"cta_link","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM

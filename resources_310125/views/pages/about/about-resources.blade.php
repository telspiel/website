                        ...
                        <div class="col-lg-4">
                            <div class="card case-card">
                                <div class="card-body">
                                    ...
                                    <a href="{{$media->third_party_link}}" class="d-flex align-items-center gap-2 pt-2 grey-1 fw-semibold translate" target="_blank">{{$media->cta_name}}
                    ...
                    <div class="col-lg-4">
                        <div class="card case-card">
                            <div class="card-body">
                                ...
                                <h6 class="fs-5 fw-bold hover-color">{{$blog->title}}</h6>
                                <p>
                                    {{$blog->content}}
                                </p>
                                <a href="{{url('blog/'.$blog->cta_link)}}" class="d-flex align-items-center gap-2 pt-2 grey-1 translate fw-semibold">{{$blog->cta_name}}
                                    <img src="{{url('assets/images/icons/grey-arrow.svg')}}" class="mb-0" alt=""></a>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <nav aria-label="Page navigation example">
                            <ul class="blog-pagination my-3">
                                ...
                                @else
                                    <li>
                                        <a class="page-link" href="{{ $about_resourcespage_blogs->previousPageUrl() }}#my-section">
                                ...
                                @if ($about_resourcespage_blogs->hasMorePages())
                                    <li>
                                        <a class="page-link" href="{{ $about_resourcespage_blogs->nextPageUrl() }}#my-section">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card case-card">
                                            <div class="card-body">
                                                ...
                                                <a href="{{$webinar->third_party_link}}" target="_blank" class="d-flex align-items-center gap-2 pt-2 grey-1 translate fw-semibold">{{$webinar->cta_name}}
                                                    <img src="{{url('assets/images/icons/grey-arrow.svg')}}" class="mb-0" alt=""></a>
                                            </div>
                                        </div>
                                    </div>

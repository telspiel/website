<?php namespace App\Http\Controllers;
	...
	class AdminSolutionUspController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'Short Des','name'=>'short_des','type'=>'textarea','validation'=>'required','width'=>'col-sm-10'];

...
<html lang="en" data-bs-theme="blue-theme">
    ...
    <head>
        ...
        <!--favicon-->
        <link rel="icon" href="{{ asset('website/assets/images/favicon-32x32.png')}}" type="image/png">
        <!-- loader-->
        ...
        <link href="{{ asset('website/https://fonts.googleapis.com/css2?family=Noto+Sans:wght@300;400;500;600&display=swap')}}"
            rel="stylesheet">
        <link href="{{ asset('website/https://fonts.googleapis.com/css?family=Material+Icons+Outlined')}}" rel="stylesheet">
        <!--main css-->

        ...
        <div class="card rounded-4">
          <div class="card-body p-4">
             <div class="position-relative mb-5">
              <img src="{{ asset('website/assets/images/gallery/profile-cover.png')}}" class="img-fluid rounded-4 shadow" alt="">
              <div class="profile-avatar position-absolute top-100 start-50 translate-middle">
                <img src="{{ asset('assets/images/icon.png') }}" class="img-fluid rounded-circle p-1 bg-grd-danger shadow" width="170" height="170" alt="">
              </div>
             </div>
                ...
                <div class="d-flex align-items-start justify-content-between mb-3">
                 ...
                 <div class="full-info">
                  <div class="info-list d-flex flex-column gap-3">
                    ...
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">code</span><p class="mb-0">Role: Admin</p></div>
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">flag</span><p class="mb-0">Country: India</p></div>
                    ...
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">send</span><p class="mb-0">Email: marketing@telSpiel.com</p></div>
                    <div class="info-list-item d-flex align-items-center gap-3"><span class="material-icons-outlined">call</span><p class="mb-0">Phone: +91-120-4108800</p></div>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card-body">
                ...
                <div class="account-list d-flex flex-column gap-4">
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('website/assets/images/apps/05.png') }}" width="35" alt="">
                  ...
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('website/assets/images/apps/06.png')}}" width="35" alt="">
                    <div class="flex-grow-1">
                  ...
                  <div class="account-list-item d-flex align-items-center gap-3">
                    <img src="{{ asset('website/assets/images/apps/17.png')}}" width="35" alt="">
                    <div class="flex-grow-1">

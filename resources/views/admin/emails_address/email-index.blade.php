    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Emails </div>
                <div class="ps-3">
                                    ...
                                    <tr id="tr_category{{ $row->id }}">
                                        ...
                                        <td>
                                            <select id="status{{ $row->id }}" style="width: fit-content !important;"
                                                ...
                                                required>
                                                <option value="1" @if ($row->active == 1) selected @endif>
                                                    Active
                                                </option>
                                                <option value="0" @if ($row->active == 0) selected @endif>
                                                    Inactive
                                                </option>
                                            </select>
                                        </td>
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <form class="row g-3 form_class"
                                    action="{{ route('admin.email.save') }}" method="post"
                                    ...
                                    <div class="col-md-12">
                                        <label for="department" class="form-label">Department<span style="color:red">
                                                *</span></label>
...
@section('js')
    <script>
        ...
        function status(id, status) {
            $.ajax({
                url: `/admin/email/${id}/${status}/status`,
                type: "put",
                data: {
                    "_token": "{{ csrf_token() }}"
                },

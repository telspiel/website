...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.1.0/magnific-popup.css" />
            ...
            <div class="reduce-90px-width">
                <div class="row align-items-center gy-5">
                    <div class="col-lg-6 text-center">
                        <img src="{{url(optional(\App\Models\HomePageAboutUs::where('status','Enable')->first())->image)}}" alt="{{optional(\App\Models\HomePageAboutUs::where('status','Enable')->first())->image_alt}}" title="{{optional(\App\Models\HomePageAboutUs::where('status','Enable')->first())->image_title}}" />
                    </div>
                    <div class="col-lg-6">
                        ...
                        <h2 class="fs-44 fw-medium lh-1 text-m-32">
                            {{optional(\App\Models\HomePageAboutUs::where('status','Enable')->first())->title}}
                        </h2>
                        <p class="mb-4 mt-3 text-secondary-60">
        ...
        <div class="container">
            ...
            <div class="row align-items-center gy-5">
                <div class="col-lg-6 order-2 order-lg-1">
                    ...
                    <h2 class="fs-1 fw-medium lh-1">
                        {{optional(\App\Models\HomePageIntegration::first())->title}}
                    </h2>
                    <p class="my-4">
                        {{optional(\App\Models\HomePageIntegration::first())->detail}}
                    </p>
                    <a href="{{optional(\App\Models\HomePageIntegration::first())->url}}" class="btn btn-warning">{{optional(\App\Models\HomePageIntegration::first())->cta_link}}</a>
                </div>
                <div class="col-lg-6 text-center order-1 order-lg-2">
                    <img src="{{url(optional(\App\Models\HomePageIntegration::first())->image)}}" alt="{{optional(\App\Models\HomePageIntegration::first())->image_alt}}" title="{{optional(\App\Models\HomePageIntegration::first())->image_title}}" />
                </div>
            </div>
            </div>
    ...
    <section class="section-spacing d-none" data-aos="fade-up">

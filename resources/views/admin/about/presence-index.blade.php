    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Presence</div>
                <div class="ps-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header border-bottom-0 py-2"
                            ...
                            <h5 class="modal-title">Presence</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <form class="row g-3 form_class" action="{{ route('admin.about.presence.save') }}"
                                    ...
                                    <div class="col-md-12">
                                        <label for="iframe" class="form-label">Iframe<span style="color:red">
                                                *</span></label>
                                        <textarea type="text" class="form-control" id="iframe" name="iframe" placeholder="Iframe"
                                            required></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="address" class="form-label">Address<span style="color:red">
                                                *</span></label>
                                    ...
                                    <div class="col-md-12">
                                        <label for="phone_no" class="form-label">Phone No<span style="color:red">
                                                *</span></label>
                                    ...
                                    <div class="col-md-12 mx-auto">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <label for="image" class="form-label">Image should be (520*520) and
                                                    less
                                                    than 2MB</label>
                                                <div id="img_section">
                                                    <input id="icon" type="file" name="icon" class="dropify"
                                                        accept=".jpg, .png, image/jpeg, image/png" data-max-width="520"
                                                        data-max-height="520" data-max-file-size="2M" required
                                                        data-default-file="">
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#example').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('admin.about.presence.list') }}',
                },
                columns: [{
                        data: 'country',
                        name: 'country'
                ...
                columnDefs: [{
                    ...
                    "render": function(data, type, full) {
                        return `<a href="{{ asset('${full.icon}') }}" target="_blank"> <img src="{{ asset('${full.icon}') }}" width="100" height="100"/></a>`;
                    }
                }, {
                    "targets": 3,
                    "render": function(data, type, full) {
                        return `<textarea class="form-control" style="width:fit-content;height:150px" readonly>${full.iframe}</textarea>`;
                    }
                }, {
                    "targets": 4,
                    "render": function(data, type, full) {
                        return `<textarea class="form-control" style="width:fit-content;height:150px" readonly>${full.address}</textarea>`;
                    }
                }, {
                    "targets": 7,
                    "render": function(data, type, full) {
        ...
        function deleteLogo(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/admin/about/presence/${id}/delete`,
                        type: "delete",
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
        ...
        function brandStatus(id, status) {
            $.ajax({
                url: `/admin/about/presence/${id}/${status}/status`,
                type: "put",
                data: {
                    "_token": "{{ csrf_token() }}"
                },
        ...
        function edit(id, icon, iframe, country, city,status, address, email, phone_no) {

            $('#img_section').empty();
            var url = "/" + icon;
            var img_file = `<input id="icon" type="file" name="icon" class="dropify"
            ...
            $('#iframe').val(decodeURIComponent(iframe));
            $('#country').val(country);
            $('#city').val(city);
            $('#address').val(address);
            $('#email').val(email);

        ...
        <div class="container">
          <div class="d-flex align-items-center gap-2"> <a href="{{url(optional(\App\Models\Header::first())->logo_cta_link)}}" class="logo me-auto"> <img src="{{url(optional(\App\Models\Header::first())->logo)}}" class="img-fluid" alt="{{optional(\App\Models\Header::first())->logo_alt}}" title="{{optional(\App\Models\Header::first())->logo_title}}" /> </a> @if(!$headerMenu->isEmpty())
            ...
            <div class="ms-lg-4 ms-auto">
              <button class="btn btn-light d-none d-xl-inline">{{optional(\App\Models\Header::first())->sign_in_cta_name}}</button>
  ...
  <div class="video-background">
    ...
    <div class="content">
      ...
      <div class="section-spacing">
        <div class="container">
          <div class="row">
            <div class="col-lg-8"> <span class="badge-only mb-2"><a href="https://www.redherring.com/events/red-herring-global/2022-red-herring-top-100-global-winners/" class="grey-1" target="_blank"><img src="{{asset('assets/images/icons/trofy-yellow.svg')}}" alt=""
                                        srcset="" /> {{$getBanner->icon_text}}</a></span>
              <h1 class="text-white my-2 my-lg-4 fs-68 fw-medium lh-1 text-m-40 text-capitalize"> Transform customer interactions with our    
              ...
              <p class="fs-20 grey-1 mb-lg-4 mb-2"> Connect, collaborate and innovate with our advanced communication platform, designed to empower both consumers and brands for seamless and impactful interactions. </p>
              <a href="{{$getBanner->cta_link}}" class="btn btn-warning">{{$getBanner->cta_name}}</a> </div>
          </div>
        </div>
      </div>

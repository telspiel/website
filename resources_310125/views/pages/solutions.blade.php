...
<div class="py-4 py-lg-5 bg-gradiant-1 borderbottom">
  <div class="container">
    <div class="row gx-lg-5 align-items-center">
      ...
      <div class="col-lg-5"> <img src="{{url(optional(\App\Models\SolutionBanner::first())->image)}} aos-init aos-animate" class="w-100 hero-img" data-aos="fade-right" alt="{{optional(\App\Models\SolutionBanner::first())->image_alt}}" alt="{{optional(\App\Models\SolutionBanner::first())->image_title}}"> </div>
    </div>
  </div>
</div>

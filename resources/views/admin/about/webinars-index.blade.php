    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Webinars</div>
                <div class="ps-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header border-bottom-0 py-2"
                            ...
                            <h5 class="modal-title">Webinars</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <form class="row g-3 form_class" action="{{ route('admin.about.webinar.save') }}"
                                    ...
                                    <div class="col-md-12">
                                        <label for="short_desc" class="form-label">Short Description<span style="color:red">
                                                *</span></label>
                                        <textarea type="text" class="form-control" id="short_desc" name="short_desc" placeholder="Short Description" required></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="details" class="form-label">Details<span style="color:red">
                                                *</span></label>
                                        <textarea type="text" class="form-control" id="details" name="details" placeholder="Details" required></textarea>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="video_link" class="form-label">Video Link<span style="color:red">
                                                *</span></label>
                                        <input type="text" class="form-control" id="video_link" name="video_link"
                                            required placeholder="Video Link">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        <label for="third_party_link" class="form-label">Third Party Link<span style="color:red">
                                                *</span></label>
                                        <input type="text" class="form-control" id="third_party_link" name="third_party_link"
                                            required placeholder="Third Party Link">
                                    </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#example').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('admin.about.webinars.list') }}',
                },
                columns: [{
                        data: 'title',
                        name: 'title'
                ...
                columnDefs: [{
                    ...
                    "render": function(data, type, full) {
                        return `<div style="width: max-content !important;"><a href="#!" onclick="deleteLogo('${full.encrypt_id}')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-primary"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
                                                &nbsp;&nbsp;
                                                <a href="#!" onclick='edit("${full.encrypt_id}","${full.image}","${encodeURIComponent(full.short_desc)}","${encodeURIComponent(full.details)}","${full.image_alt}","${full.image_title}","${full.video_link}","${full.cta_name}","${full.status}","${full.third_party_link}")'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-primary"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                            </div>`;
                    }
                }]
            });
        ...
        function deleteLogo(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/admin/about/webinar/${id}/delete`,
                        type: "delete",
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
        ...
        function brandStatus(id, status) {
            $.ajax({
                url: `/admin/about/webinar/${id}/${status}/status`,
                type: "put",
                data: {
                    "_token": "{{ csrf_token() }}"
                },
        ...
        function edit(id, image, short_desc, details, image_alt, image_title, video_link, cta_name, status,
            third_party_link) {

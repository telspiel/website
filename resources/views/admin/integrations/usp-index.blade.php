                                    ...
                                    <tr id="tr_category{{ $row->id }}">
                                        ...
                                        <td>
                                            <textarea class="no-border form-control textarea-dimension" name="shortdesc" readonly>
                                                {!! nl2br(e($row->short_des)) !!}</textarea>
                                        </td>
                                        <td>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <form class="row g-3 form_class" action="{{ route('admin.integrations.usp.save') }}"
                                    ...
                                    <div class="col-md-12">
                                        <label for="short_des" class="form-label">Short Description<span style="color:red">
                                                *</span></label>
                                        <textarea type="text" class="form-control" id="short_des" name="short_des" placeholder="Content" required></textarea>
                                    </div>
                                    <div class="col-md-12">
...
@section('js')
    <script>
        ...
        function delete_category(id, trid) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/admin/integrations/usp/${id}/delete`,
                        type: "delete",
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
        ...
        function status(id, status) {
            $.ajax({
                url: `/admin/integrations/usp/${id}/${status}/status`,
                type: "put",
                data: {
                    "_token": "{{ csrf_token() }}"
                },

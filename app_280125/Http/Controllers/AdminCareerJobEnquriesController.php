<?php namespace App\Http\Controllers;
	...
	class AdminCareerJobEnquriesController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "career_job_enquries";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Job Id","name"=>"job_id","join"=>"about_carrier_jobs,title"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Job Id','name'=>'job_id','type'=>'select2','validation'=>'required|integer|min:0','width'=>'col-sm-10','datatable'=>'job,id'];
			...
			$this->form[] = ['label'=>'Email','name'=>'email','type'=>'email','validation'=>'required|min:1|max:255|email|unique:career_job_enquries','width'=>'col-sm-10','placeholder'=>'Please enter a valid email address'];
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"Job Id","name"=>"job_id","type"=>"select2","required"=>TRUE,"validation"=>"required|integer|min:0","datatable"=>"job,id"];
			...
			//$this->form[] = ["label"=>"Email","name"=>"email","type"=>"email","required"=>TRUE,"validation"=>"required|min:1|max:255|email|unique:career_job_enquries","placeholder"=>"Please enter a valid email address"];

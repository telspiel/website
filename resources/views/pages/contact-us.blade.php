                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-floating">
                                            <input type="text" class="form-control @error('name') is-invalid @enderror"
                                                id="yourname" name="name" placeholder="Your Name" autocomplete="off"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-floating">
                                            <input type="text"
                                                ...
                                                id="cname" name="company_name" placeholder="Company Name"
    ...
    @enderror -->
                                    ...
                                    <div class="col-lg-12">
                                        <div style="padding: 1em;">
                                            <input id="checkbox" class="input_check" type="checkbox" checked />
                                            <p for="checkbox" class="check_text">Accept terms and conditions for receiving SMS, RCS,
                                                WhatsApp or Email communication.</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                ...
                <div class="col-lg-4">
                    <div class="card bg-gradiant-2 border-0 p-3 h-100 rounded-24">
                        <div class="card-body">
                            ...
                            <a href="mail:{{ $contact_us_page->email }}"
                                class="mb-2 d-block">{{ $contact_us_page->email }}</a>
                            <br>
                            <h5 class="fw-bold mb-0">Phone Number</h5>
                            <a href="tel:+91-120-4108800" class="d-block">{{ $contact_us_page->phone_no }}</a>

                            <ul class="social-icons-2">
                                <li><a href="{{ $contact_us_page->twitter_link }}"><img
                                            src="{{ url('assets/images/icons/twitter.svg') }}" alt=""></a></li>
                                <li><a href="{{ $contact_us_page->insta_link }}"><img
                                            src="{{ url('assets/images/icons/instagram.svg') }}" alt=""></a></li>
                                <li><a href="{{ $contact_us_page->facebook_link }}"><img
                                            src="{{ url('assets/images/icons/facebook.svg') }}" alt=""></a></li>
                                <li><a href="{{ $contact_us_page->linkdin_link }}"><img
                                            src="{{ url('assets/images/icons/linkedin.svg') }}" alt=""></a></li>
                            </ul>
                        </div>
                    </div>
                </div>

...
<footer class="footer">
    <div class="container">
        <div class="row gy-lg-5 gy-4">
            ...
            <div class="col-lg-4">
                <img src="{{ url(optional(\App\Models\Footer::first())->logo) }}" class="mb-4"
                    alt="{{ optional(\App\Models\Footer::first())->logo_alt }}"
                    title="{{ optional(\App\Models\Footer::first())->logo_title }}">
            ...
            <div class="col-lg-12 ">
                <ul class="footer-social">
                    <li><a href="{{ optional(\App\Models\Footer::first())->twitter_x }}" target="_blank">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="30.975" height="28"
                                viewBox="0 0 30.975 28">
                                <path
                                    d="M26.277,3.375h4.752L20.65,15.235l12.21,16.14H23.3L15.81,21.588,7.249,31.375H2.49l11.1-12.687L1.884,3.375h9.8l6.764,8.945Zm-1.669,25.16h2.632L10.251,6.067H7.424Z"
                                    transform="translate(-1.884 -3.375)" fill="#8b9da7" />
                            </svg>
                        </a></li>
                    <li><a href="{{ optional(\App\Models\Footer::first())->insta }}" target="_blank">

                            <svg xmlns="http://www.w3.org/2000/svg" width="28.006" height="28"
                                viewBox="0 0 28.006 28">
                                <path
...
<div class="container py-4 py-lg-5">
    <div class="row gy-3">
        ...
        <div class="col-lg-3">
            <a href="mail:{{ optional(\App\Models\Footer::first())->email }}"
                class="text-secondary d-flex gap-1 align-items-center"><img width="15"
                    src="{{ asset('assets/images/icons/mail.svg') }}" alt="">
                {{ optional(\App\Models\Footer::first())->email }}</a>
        </div>
        <div class="col-lg-2">
            <a href="tel:{{ optional(\App\Models\Footer::first())->phone }}"
                class="text-secondary d-flex gap-1 align-items-center"><img width="15"
                    src="{{ asset('assets/images/icons/telephone.svg') }}" alt="">
                {{ optional(\App\Models\Footer::first())->phone }}</a>
        </div>
        <div class="col-lg-3">
            <address class="mb-0 text-secondary d-flex gap-1 align-items-start">
                <img src="{{ asset('assets/images/icons/pin.svg') }}" alt="">
                {{ optional(\App\Models\Footer::first())->address }}
            </address>
        </div>
    </div>
</div>

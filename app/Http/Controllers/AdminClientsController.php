<?php namespace App\Http\Controllers;
	...
	class AdminClientsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col[] = ["label"=>"Show On Home Page","name"=>"show_on_home_page_chkbox"];
			...
			$this->form[] = ['label'=>'Client Name','name'=>'client_name','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Logo','name'=>'logo','type'=>'upload','validation'=>'required','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Show On Home Page','name'=>'show_on_home_page_chkbox','type'=>'radio','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Yes;No'];

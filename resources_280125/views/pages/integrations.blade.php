...
@section('content')
                            ...
                            <div class="row pt-lg-4  gx-lg-5">
                                ...
                                <div class="col-lg-10">
                                    <div class="tab-content" id="myTab2Content">
                                        ...
                                        $subCatText = str_replace(' ', '-', $subCatText);
                                        @endphp
                                        <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="{{$subCatText}}" role="tabpanel">
                                            <div class="row">
    ...
    <section class="section-spacing position-relative" data-aos="fade-up">
        <div class="container">
            ...
            <ul class="whattheysay mt-lg-5 mt-2">
                ...
                <li><img src="{{url($benifit->icon)}}" alt="{{$benifit->one_liner_content}}" style="width: 52px!important; height: 52px!important;">

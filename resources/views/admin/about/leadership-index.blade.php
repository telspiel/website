    ...
    <main class="main-wrapper">
        <div class="main-content">
            ...
            <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                <div class="breadcrumb-title pe-3">Leadership</div>
                <div class="ps-3">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header border-bottom-0 py-2"
                            ...
                            <h5 class="modal-title">Leadership</h5>
                        ...
                        <div class="modal-body">
                            <div class="form-body">
                                <form class="row g-3 form_class" action="{{ route('admin.about.leadership.save') }}"
                                    ...
                                    <div class="col-md-12">
                                        <label for="position" class="form-label">Position<span style="color:red">
                                                *</span></label>
                                        <input type="text" class="form-control" id="position" name="position"
                                            placeholder="Position" required>
                                    </div>
                                    <div class="col-md-12">
                                        <label for="linkedin_url" class="form-label">Linkedin URL<span style="color:red">
                                                *</span></label>
                                    ...
                                    <div class="col-md-12 mx-auto">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <label for="image" class="form-label">Image should be (950*1100) and
                                                    less
                                                    than 5MB</label>
                                                <div id="img_section">
                                                    <input id="image" type="file" name="image" class="dropify"
                                                        accept=".jpg, .png, image/jpeg, image/png" data-max-width="950"
                                                        data-max-height="1100" data-max-file-size="5M" required
                                                        data-default-file="">
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            table = $('#example').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('admin.about.leadership.list') }}',
                },
                columns: [{
                        data: 'name',
                        name: 'name'
                ...
                columnDefs: [{
                    ...
                    "render": function(data, type, full) {
                        return `<div style="width: max-content !important;"><a href="#!" onclick="deleteLogo('${full.encrypt_id}')"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 text-primary"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></a>
                                                &nbsp;&nbsp;
                                                <a href="#!" onclick='edit("${full.encrypt_id}","${full.image}","${encodeURIComponent(full.short_desc)}","${full.name}","${full.designation}","${full.status}","${full.image_alt}","${full.image_title}","${full.linkedin_url}","${full.position}")'><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2 text-primary"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a>
                                            </div>`;
                    }
                }]
            });
        ...
        function deleteLogo(id) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `/admin/about/leadership/${id}/delete`,
                        type: "delete",
                        data: {
                            "_token": "{{ csrf_token() }}"
                        },
        ...
        function brandStatus(id, status) {
            $.ajax({
                url: `/admin/about/leadership/${id}/${status}/status`,
                type: "put",
                data: {
                    "_token": "{{ csrf_token() }}"
                },
        ...
        function edit(id, image, short_desc, name, designation, status, image_alt, image_title, linkedin_url,position) {

<?php namespace App\Http\Controllers;
	...
	class AdminSuccessStoryTestimonialsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "success_story_testimonials";
			...
			$this->form[] = ['label'=>'Short Desc','name'=>'short_desc','type'=>'textarea','validation'=>'required|string|min:5|max:5000','width'=>'col-sm-10'];

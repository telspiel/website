<?php namespace App\Http\Controllers;
	...
	class AdminAboutCarrierpageTestimonialsController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "about_carrierpage_testimonials";
			...
			$this->form[] = ['label'=>'Video Link','name'=>'video','type'=>'text','width'=>'col-sm-10'];
			...
			//$this->form[] = ['label'=>'Image Title','name'=>'image_title','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Video Link','name'=>'video','type'=>'text','width'=>'col-sm-10'];
			//$this->form[] = ['label'=>'Status','name'=>'status','type'=>'select','validation'=>'required','width'=>'col-sm-10','dataenum'=>'Enable;Disable'];
			# OLD END FORM

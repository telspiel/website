<?php namespace App\Http\Controllers;
	...
	class AdminIntegrationUspController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->table = "integration_usp";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"Title","name"=>"title"];
			$this->col[] = ["label"=>"Short Des","name"=>"short_des"];
			...
			$this->form[] = ['label'=>'Short Des','name'=>'short_des','type'=>'text','validation'=>'required','width'=>'col-sm-10'];
